...
class ILESharedConfiguration():
    ...
    def get_excluded_colors(self) -> List[str]:
        """Returns all the material colors specifically excluded from being
        randomly generated by the current ILE configuration."""
        return self._excluded_colors

    def set_excluded_colors(self, excluded_colors: List[str]) -> None:
        """Sets all the material colors specifically excluded from being
        randomly generated by the current ILE configuration."""
        self._excluded_colors = excluded_colors

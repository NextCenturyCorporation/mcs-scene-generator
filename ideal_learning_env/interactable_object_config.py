...
from generator import ObjectDefinition, base_objects, geometry, util
...
class InteractableObjectConfig():
    ...
    def create_instance(
        ...
        """Create and return an instance of this specific configured object."""
        idl = None
        ...
        if not idl:
            ...
            raise ILEException(
                ...
                f"shape={self.shape} location={location_str}")
    ...
    def _attach_location(
        ...
        location['boundingBox'] = geometry.calc_obj_coords(
            location['position']['x'],
            location['position']['z'],
            defn.dimensions.x / 2.0,
            defn.dimensions.z / 2.0,
            defn.offset.x,
            defn.offset.z,
            location['rotation']['y']
        )
